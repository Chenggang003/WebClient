 ...
 * 
 */
@WebServiceClient(name = "ServiceService", targetNamespace = "http://service.matic.com/", wsdlLocation = "http://10.83.33.106:8088/WebService/TheService?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICESERVICE_QNAME = new QName("http://service.matic.com/", "ServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.83.33.106:8088/WebService/TheService?wsdl");
    ...
    public com.matic.client.Service getServicePort() {
        return super.getPort(new QName("http://service.matic.com/", "ServicePort"), Service.class);
    }
     ...
     */
    @WebEndpoint(name = "ServicePort")
    public com.matic.client.Service getServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.matic.com/", "ServicePort"), Service.class, features);
    }
