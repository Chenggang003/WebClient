...
public class HelloServiceService extends Service {
    ...
    public final static QName SERVICE = new QName("http://web.matic.com/", "HelloServiceService");
    public final static QName HelloServicePort = new QName("http://web.matic.com/", "HelloServicePort");
    static {
        URL url = null;
        try {
            url = new URL("http://10.83.33.106:8080/WebService/service/helloService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://10.83.33.106:8080/WebService/service/helloService?wsdl");
        }
        WSDL_LOCATION = url;
    }
